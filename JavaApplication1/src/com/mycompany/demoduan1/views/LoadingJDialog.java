        ...
        public void init() {
           ...
           new Timer(10, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int x =  pgbLoading.getValue();
                if(x<pgbLoading.getMaximum()){
                pgbLoading.setValue( x + 1);
            }else{
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(pgbLoading, javax.swing.GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(214, 214, 214)
